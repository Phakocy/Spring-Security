...
import amigosecurity.example.jwt.model.AddRoleToUserForm;
...
@GetMapping("/usersm")
    ...
    public ResponseEntity<AppUser> insertUser(@RequestBody AppUser user){
    ...
    public ResponseEntity<?> assignRoleToUSer(@RequestBody AddRoleToUserForm form){
    ...
    public void refreshToken (HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")){
            ...
            try {
                String refreshToken = authorizationHeader.substring("Bearer ".length()); //Remove "Bearer " from the refreshToken put inside the header in postman
                ...
                String accessToken = JWT.create()
                        ...
                        .withExpiresAt(new Date(System.currentTimeMillis() + 10 * 60 * 1000)) // 30minutes added to the current system time
